...
namespace TechC
{
    ...
    public class AIActionWeight
    {
        ...
        /// 重みを設定（範囲チェック付き）
        /// </summary>
        /// <param name="newWeight">新しい重み値</param>
        ...
        public void AdjustWeight(float multiplier)
        {
            weight = Mathf.Clamp01(weight * multiplier);
        }
        ...
        {
            return $"{actionType}: {weight:F2} ({weight * 100:F0}%)";
        }
    }
}
